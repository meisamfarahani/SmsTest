...
export function pushNotif(id, title, subText,message,playSound, channelId, bigText, priority) {
  PushNotification.localNotification({
    ...
    priority: priority, // (optional) set notification priority, default: high
    ...
    subtitle: subText, // (optional) smaller title below notification title
